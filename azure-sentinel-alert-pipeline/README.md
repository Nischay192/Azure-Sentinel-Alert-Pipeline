...
<!-- Write 4-6 sentences in your own words for the interview
prep folder. Good things to cover:
- How Azure Sentinel sits on top of Log Analytics / Azure Monitor
- What KQL is and how it differs from SQL
- One real breach from the rule references that stuck with you
- Why MITRE ATT&CK tactics matter for tagging detections
- How you'd extend this pipeline for your target company -->
